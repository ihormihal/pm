...
<div class="pagination" id="pagination">
	...
	{if $current_page_num>2}<a class="prev_page_link" href="{url page=$current_page_num-1}" title="Назад"></a>{/if}
	{if $current_page_num<$total_pages_num}<a class="next_page_link" href="{url page=$current_page_num+1}" title="Далее"></a>{/if}
