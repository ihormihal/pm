...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	$saved_md = file_put_contents('data/translate_md.json',json_encode($data['md']));
	if(!$saved_ru){
	...
	if(!$saved_md){
		$output['error'][] = 'MD translation not saved!';
	}else{
		$output['success'][] = 'MD translation successfully saved!';
	}
